...
specifically structured YAML grading policy file representing the class
syllabus and the assignment grades in CSV (comma-separated value) format
from Gradescope (Singh et al. 2017) (or other similar learning
management systems). The package uses these two inputs to break down
wide range of complex syllabi into the series of nested methodical
aggregation steps.
...
\bottomrule\noalign{}
\endlastfoot
\includegraphics[width=\textwidth,height=2.47222in]{with_nemogb_workflow.png}
&
\includegraphics[width=\textwidth,height=2.47222in]{without_nemogb_workflow.png} \\
\end{longtable}
...
\leavevmode\vadjust pre{\hypertarget{ref-blackboard_calculate_grades}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-GradeR}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-canvas_gradebook_guide}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Gradebook-App}{}}%
