...
#'   \item{CATEGORIES}{syllabus is broken down into categories with their respective grading criteria}
...
#'   \item{CUTOFF}{each cutoff reflects the lower bound cutoff for each letter grade: A,B,C,D,F}
#'   ...
#' }
#' @examples
#' policy_demo
