...
This vignette details the specific structure of exported Canvas files. For information on how to use Canvas grade data with Gradebook, view the [Working With Canvas Data](https://gradebook-dev.github.io/gradebook/articles/working-with-canvas-data.html) vignette instead. This vignette details in depth information about Canvas file exports for curious advanced users.
