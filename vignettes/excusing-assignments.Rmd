...
## Notes on the Interaction between Dropped Assignments and Category Drops
...
As mentioned above, every policy category must have at least one un-excused assignment for all students. If any student has all assignments excused for some category, Gradebook will raise an error detailing the student and category.
