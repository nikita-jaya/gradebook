...
First, read in your YAML policy file. `process_policy()` checks the formatting of the policy file. Finally, `get_grades()` grades your assignments based on your policy file.
