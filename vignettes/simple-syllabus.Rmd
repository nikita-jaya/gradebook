...
-   The `weights` of a cateogy with aggregation `weighted_mean` should be corresponding order with the `assignments.`

-   Categories cannot have the same name as any assignments.
