...
```{r, echo=FALSE}
simple_syllabus_data <- readr::read_csv(system.file("extdata", "simple_syllabus_data.csv", package = "gradebook"))
...
validated_policy <- validate_policy(policy, gs = simple_syllabus_data)

grades <- get_grades(policy = validated_policy, gs = simple_syllabus_data)
```
