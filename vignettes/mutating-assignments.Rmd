...
```{r}
grades <- gs_data |>
  by_points(aggregate_assign = "ps_1", sub_assigns = c("ps_1_written", "ps_1_code") ) |>
  by_points(aggregate_assign = "ps_2", sub_assigns = c("ps_2_written", "ps_2_code") ) |>
...
pmap_function <- function(gs_data, aggregate_assign, aggregation,sub_assigns, ...){
...
a_a <- list("ps1", "ps2")
s_a <- list(c("ps_1_written", "ps_1_code"), c("ps_2_written", "ps_2_code"))
a <- c("by_points", "by_points")

pmap(list(a_a, a, s_a), pmap_function)

#hypothetically, this setup???
#modify2(gs_data, pmap(list(.x, a_a, a, s_a), pmap_function))
```
