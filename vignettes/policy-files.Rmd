...
This is generally true for all syllabi. First, there is a penalty for lateness (i.e. penalize 25% for a 1 day lateness), then drop lowest scoring assignments if applicable, then apply aggregations of assignments beginning with the most nested category level going backwards up the levels towards `Overall Grade`.  
