...
```
Now, we will walk through a moderately complex syllabus and its Gradebook implementation with 5 students in the class. Let's start with what this syllabus would look like on a class website.
...
```{r, include = FALSE}
library(gradebook)
read_policy(system.file("extdata", "moderate_syllabus.yaml", package = "gradebook"))
```
