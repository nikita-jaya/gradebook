...
Advanced users wishing to gain a deep understanding of how Canvas data is structured can also read the [Detailed Canvas Export Info](https://gradebook-dev.github.io/gradebook/articles/detailed-canvas-export-info.html) vignette. 
...
Below is the dataframe after being transformed by Gradebook. 
...
For full information on the formatting of Canvas exported data, see the [Detailed Canvas Export Info](https://gradebook-dev.github.io/gradebook/articles/detailed-canvas-export-info.html) vignette. 
